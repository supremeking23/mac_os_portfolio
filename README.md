...
before navbar starts, we need to do what he did,
1.  create jsconfig.json file and type something
2. vite.config.js -- forgot what he did, but it is something to do with components -- this is for path aliasing
...
dayjs - javascript date utility
1. run - npm i dayjs


Day 1 - What have we learn ? Jan 18
1. path aliasing on vite.config.ts
2. <time> html semantic is an actual html code
3. .map(() => ()) --- will render directly what is inside of it . Unlike using {} , you will be required to add `return` keyword
